...
"}"));
        ...
        lineEdit->setGeometry(QRect(110, 40, 211, 21));
...
"border: 0px solid;}"));
        ...
        sizePolicy.setHeightForWidth(horizontalWidget_7->sizePolicy().hasHeightForWidth());
        horizontalWidget_7->setSizePolicy(sizePolicy);
        horizontalWidget_7->setMinimumSize(QSize(330, 100));
        horizontalLayout_15 = new QHBoxLayout(horizontalWidget_7);
        ...
        groupBox_2 = new QGroupBox(horizontalWidget_7);
        groupBox_2->setObjectName(QStringLiteral("groupBox_2"));
        sizePolicy1.setHeightForWidth(groupBox_2->sizePolicy().hasHeightForWidth());
        groupBox_2->setSizePolicy(sizePolicy1);
        groupBox_2->setMinimumSize(QSize(40, 40));
...
""));
        ...
        checkBox_5->setGeometry(QRect(270, 20, 70, 17));
        ...
        verticalLayout_14->addWidget(horizontalWidget_7);

        horizontalWidget_3 = new QWidget(centralWidget);
        ...
        horizontalWidget_3->setMinimumSize(QSize(330, 70));
...
"border: 0px solid;}"));
        ...
        verticalLayout_14->addWidget(horizontalWidget_3);
