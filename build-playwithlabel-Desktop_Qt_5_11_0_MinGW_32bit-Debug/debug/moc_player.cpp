...
#include "../../playwithlabel/player.h"
...
QT_MOC_LITERAL(4, 29, 6), // "urutan"
QT_MOC_LITERAL(5, 36, 5) // "kunci"

    },
    "Player\0processedImage\0\0image\0urutan\0"
    "kunci"
};
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->urutan((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Player::*)(const QImage & );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Player::urutan)) {
                *result = 1;
                return;
            }
        }
